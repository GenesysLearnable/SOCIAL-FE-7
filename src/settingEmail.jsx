...
const SettingEmail = () => {
  const dataItems = [
    { name: "Change Email", text: "We’ll send a 6 digit OTP to your current email address.", value: "Enter OTP", otp: "Send OTP" },

    { name: "Change Password", text: "We’ll send a 6 digit OTP to your current email address.", value: "Enter OTP", otp: "Send OTP" },
  ...
  return (
    <div>
      ...
      <img src={closecircle} alt="close" className='closecircleButton'/>
        ...
        <input type="password" placeholder="New Password" className='input sectionIput' />
